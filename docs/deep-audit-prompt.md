...
16. TRANSITIONS (set-phase.mjs:64-74) has no keys for abandoned/blocked → unrecoverable DAG dead-ends; --force does NOT help (the DAG check :93 runs before the --force branch :311). Verify abandoned/blocked now have re-entry edges.
