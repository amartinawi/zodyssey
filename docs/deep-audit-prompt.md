...
17. CLAUDE_CLI (consult.mjs:457, judge.mjs:262) is taken raw, unvalidated, despite the "Environment overrides" section of SKILL.md (SKILL.md:450) formerly claiming "all validated". Verify it's validated or the SKILL.md claim is corrected.
