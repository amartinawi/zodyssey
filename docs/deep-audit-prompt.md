...
13. post-tool.mjs:89-108 + stop.mjs:40-64 — findActiveRun is FLAT (no DFS); known-issue #6a was fixed in pre-tool.mjs only. Nested-repo runs: parallel-cap ledger never drains (30-min stall), resume checkpoint never written. Verify findActiveRun was extracted to a shared module.
