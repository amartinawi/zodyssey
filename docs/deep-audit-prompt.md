...
17. CLAUDE_CLI (consult.mjs:339, judge.mjs:262) is taken raw, unvalidated, despite the "Environment overrides" section of SKILL.md (SKILL.md:360) formerly claiming "all validated". Verify it's validated or the SKILL.md claim is corrected.
