...
- `harness.mjs:48,62` gate on `seed.repo.includes("REPLACE_WITH")`; the seeds say
...
4. **`install.mjs:450`** — writes a `ZODYSSEY_UNGATE_BASH` claim into every user's `AGENTS.md`.
