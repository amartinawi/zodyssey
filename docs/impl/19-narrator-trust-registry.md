...
- Do not ingest `outcomes.jsonl` — it is an unauthenticated plain append (`set-phase.mjs:506-527`
...
contentless re-anchors; `judge.mjs:304` family (16 citations) repointed at the derivation line with
