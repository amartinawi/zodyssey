...
`skills/odyssey/scripts/judge.mjs:105` (`## Scoring rubric`, weights 0.4/0.2/0.2/0.1/0.1) and the
output-contract literal at `skills/odyssey/scripts/judge.mjs:130`. The external auditor prompt
