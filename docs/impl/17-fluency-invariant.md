...
`skills/odyssey/scripts/judge.mjs:226` (`## Scoring rubric`, weights 0.4/0.2/0.2/0.1/0.1) and the
output-contract literal at `skills/odyssey/scripts/judge.mjs:252`. The external auditor prompt
