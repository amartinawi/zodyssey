...
(`state.consult.history`, written by `skills/odyssey/scripts/consult.mjs:1261`; phase `audited`,
set per `skills/odyssey/SKILL.md:299`) but nothing reports it: `run-report.mjs`'s `--json` record —
