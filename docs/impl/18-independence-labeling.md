...
(`state.consult.history`, written by `skills/odyssey/scripts/consult.mjs:1348`; phase `audited`,
set per `skills/odyssey/SKILL.md:300`) but nothing reports it: `run-report.mjs`'s `--json` record —
