...
Already named in the ledger: `CHANGELOG.md:525` (v0.5.1, *Known, not fixed*) — "The Edit-path scope
...
- `CHANGELOG.md:525` — move the v0.5.1 *Known, not fixed* bullet into the new version's **Fixed**
  (shape below).
...
with its own precedent at `CHANGELOG.md:464` (a structural gate change "wants its own release and
