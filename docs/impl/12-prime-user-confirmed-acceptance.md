...
- PRIME (phase −1) produces the primed brief carrying "· intent + success criteria"
  ...
  (`skills/odyssey/SKILL.md:119`, `:424`), and the momus-loop safety rail (`:335`). **None of these
...
`skills/odyssey/SKILL.md:441`). Scaffold stamps `plans/<slug>.task.md` — the G5 file it already
...
THE ORIGINAL TASK (`consult.mjs:1096-1100`, `:1344`) and the stamp is a first-line HTML comment in what is
...
- **Byte-exact consumers of `<slug>.task.md`.** `consult.mjs` reads the file as THE ORIGINAL TASK
  for scope-fidelity judgment (`consult.mjs:1096-1100`, `:1344`); a first-line HTML comment is additive to
