...
- The Bash gate has been deleted **twice** — v0.1.1 (5c99927) and v0.2.0 (e57b01b) — and both
  ...
  the v0.1.2 restore entry (`CHANGELOG.md:678`) carries the post-mortem note that the first fix
  "did not hold".
...
(`CHANGELOG.md:678`) was not a logic bug at all — it was this variable's silent ambient presence in
...
path by which the second deletion shipped unnoticed (`CHANGELOG.md:518`: audits review the diff in
