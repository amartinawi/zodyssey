...
skills/odyssey/scripts/consult.mjs:1322 post-done, :361 plan-audit, :625 multi-auditor pass), and
...
(skills/odyssey/scripts/consult.mjs:1056-1057). The only post-spawn check catches COMMITTED moves
(the HEAD-moved race warning re-reads `rev-parse HEAD`, consult.mjs:1382-1386) — a working-tree
...
`run_start_sha`/`audit_head` (consult.mjs:1569-1571). Deterministic git plumbing only — zero
