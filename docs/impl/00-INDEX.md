...
| 06 | token-telemetry-run-close | 05 | Wiring already exists (skills/odyssey/scripts/set-phase.mjs:430, skills/odyssey/scripts/run-report.mjs:86); the defects are the null population (2/184, measured 2026-08-16) and attribution (skills/odyssey/scripts/lib/tokens.mjs:150). Telemetry numbers are corpus metrics — after 05. | Token counts are populated and attributed per run. |
