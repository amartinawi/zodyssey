...
skills/odyssey/scripts/consult.mjs:1412 post-done, :361 plan-audit, :625 multi-auditor pass), and
...
(skills/odyssey/scripts/consult.mjs:1146-1147). The only post-spawn check catches COMMITTED moves
(the HEAD-moved race warning re-reads `rev-parse HEAD`, consult.mjs:1472-1476) — a working-tree
...
`run_start_sha`/`audit_head` (consult.mjs:1659-1661). Deterministic git plumbing only — zero
