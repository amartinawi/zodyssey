...
terminal auto-append fires on `done` and `audited` only (skills/odyssey/scripts/set-phase.mjs:454),
...
a continued form was never discovered: in `CHANGELOG.md:635/:800` only the `:635` half was ever
