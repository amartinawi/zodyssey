...
|---|---|
| Per-test regression granularity | Concession confirmed: per-test granularity needs runner-specific parsing that would rot (docs/MEASUREMENT.md:81). Both ideation passes say do not build. Left out. |
