...
a continued form was never discovered: in `CHANGELOG.md:919/:1020` only the `:887` half was ever
...
verifies the external-audit lane none of them touches); open C5 (00-INDEX.md:223-228 — dry-run
