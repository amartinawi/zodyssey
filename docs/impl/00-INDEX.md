...
skills/odyssey/scripts/consult.mjs:1286 post-done, :361 plan-audit, :625 multi-auditor pass), and
...
(skills/odyssey/scripts/consult.mjs:1020-1021). The only post-spawn check catches COMMITTED moves
(the HEAD-moved race warning re-reads `rev-parse HEAD`, consult.mjs:1346-1350) — a working-tree
...
`run_start_sha`/`audit_head` (consult.mjs:1533-1535). Deterministic git plumbing only — zero
