...
| 07 | b10-pre-edit-lint-baseline | — | skills/odyssey/hooks/lib/lint-invocation.mjs:53 lints post-edit only and blocks (skills/odyssey/hooks/post-tool.mjs:143) with no baseline to compare against. Independent of the other tracks. | Lint regressions are caught against a committed baseline. |
