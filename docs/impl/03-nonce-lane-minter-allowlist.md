...
(`skills/odyssey/SKILL.md:446`: "the nonce only exists after a real `Task(zodyssey:momus)` call the
...
(`skills/odyssey/SKILL.md:442`, `skills/odyssey/references/scripts.md:59`). The only
...
- `README.md:135` — comparison-table row "Review verdicts are read, not assumed": extend the
  ...
  lookalike namespace.
- `skills/odyssey/SKILL.md:442-448` — the review-gate chain description: the sentence "the nonce
...
- **Known, not fixed** — name them; the next audit should not have to find them:
  ...
  - The orchestrator-adversary residual stands unchanged (`skills/odyssey/SKILL.md:448`: the nonce
