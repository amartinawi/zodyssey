...
`docs/DESIGN.md:433`; `coverage-delta` at `CHANGELOG.md:808` only (it has no
...
never had" (`CHANGELOG.md:640`) — and shipped them unwired:
...
heading "the three gates `MEASUREMENT.md` promised and never had" (`CHANGELOG.md:640`), each
...
- `README.md:131-132` — comparison-table rows: "Imports resolve" (`:132`) can now name the
