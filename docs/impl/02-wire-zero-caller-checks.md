...
`resolve-capabilities` at `skills/odyssey/SKILL.md:444`,
`skills/odyssey/references/capabilities.md:108`,
`skills/odyssey/references/scripts.md:50`, `docs/RESUME.md:124`, `docs/RESUME.md:210`,
`docs/DESIGN.md:458`; `coverage-delta` at `CHANGELOG.md:1161` only (it has no
...
never had" (`CHANGELOG.md:961`) — and shipped them unwired:
...
heading "the three gates `MEASUREMENT.md` promised and never had" (`CHANGELOG.md:961`), each
...
- `skills/odyssey/SKILL.md:438-444` — the transition one-liners: entering `verify` / entering
