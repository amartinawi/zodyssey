...
`docs/DESIGN.md:422`; `coverage-delta` at `CHANGELOG.md:673` only (it has no
...
never had" (`CHANGELOG.md:505`) — and shipped them unwired:
...
heading "the three gates `MEASUREMENT.md` promised and never had" (`CHANGELOG.md:505`), each
