...
`docs/DESIGN.md:433`; `coverage-delta` at `CHANGELOG.md:857` only (it has no
...
never had" (`CHANGELOG.md:689`) — and shipped them unwired:
...
heading "the three gates `MEASUREMENT.md` promised and never had" (`CHANGELOG.md:689`), each
