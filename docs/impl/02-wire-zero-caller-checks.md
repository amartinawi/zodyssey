...
`docs/DESIGN.md:423`; `coverage-delta` at `CHANGELOG.md:735` only (it has no
...
never had" (`CHANGELOG.md:567`) — and shipped them unwired:
...
heading "the three gates `MEASUREMENT.md` promised and never had" (`CHANGELOG.md:567`), each
...
- `README.md:131-132` — comparison-table rows: "Imports resolve" (`:129`) can now name the
