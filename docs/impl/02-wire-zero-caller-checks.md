...
`docs/DESIGN.md:458`; `coverage-delta` at `CHANGELOG.md:1037` only (it has no
...
never had" (`CHANGELOG.md:857`) — and shipped them unwired:
...
heading "the three gates `MEASUREMENT.md` promised and never had" (`CHANGELOG.md:857`), each
