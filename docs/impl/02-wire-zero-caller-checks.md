...
`resolve-capabilities` at `skills/odyssey/SKILL.md:421`,
...
`docs/DESIGN.md:458`; `coverage-delta` at `CHANGELOG.md:1121` only (it has no
...
never had" (`CHANGELOG.md:909`) — and shipped them unwired:
...
heading "the three gates `MEASUREMENT.md` promised and never had" (`CHANGELOG.md:909`), each
...
- `skills/odyssey/SKILL.md:415-421` — the transition one-liners: entering `verify` / entering
