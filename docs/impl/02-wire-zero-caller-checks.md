...
`docs/DESIGN.md:433`; `coverage-delta` at `CHANGELOG.md:878` only (it has no
...
never had" (`CHANGELOG.md:710`) — and shipped them unwired:
...
heading "the three gates `MEASUREMENT.md` promised and never had" (`CHANGELOG.md:710`), each
