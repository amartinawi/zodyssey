...
`docs/DESIGN.md:458`; `coverage-delta` at `CHANGELOG.md:976` only (it has no
...
never had" (`CHANGELOG.md:808`) — and shipped them unwired:
...
heading "the three gates `MEASUREMENT.md` promised and never had" (`CHANGELOG.md:808`), each
