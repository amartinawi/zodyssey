...
(`CHANGELOG.md:5` dated 2026-08-15, entry at `CHANGELOG.md:160`; commit `6b0b428`
...
1. **A null is reason-blind.** `collectRunTokens` returns null from at least five distinct
   ...
   `skills/odyssey/scripts/run-report.mjs:116` flattens all five into the single sentinel
...
- `docs/MEASUREMENT.md:24` (the `Tokens / todo completed` metric row) and `:31` (the
  ...
  historical. The record-schema sketch at `docs/MEASUREMENT.md:124-129` gains the inert shape.
