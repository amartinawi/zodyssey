...
Candidate C4, docs/impl/00-INDEX.md:210-216. Proved before any edit: the hermetic RED probe of
...
- **`docs/impl/00-INDEX.md`** — queue row 22 lands line-count-neutral (218 held); candidate
  C4's paragraph (docs/impl/00-INDEX.md:210-216) takes its promotion stamp in-row, with the
