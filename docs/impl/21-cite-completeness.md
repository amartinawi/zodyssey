...
- **Slash and bare-colon continuations.** In `CHANGELOG.md:813/:978` — the gate-deletion history
...
`CHANGELOG.md:961`, which resolves and will pin happily — and points at installer prose, not the
