...
- **Slash and bare-colon continuations.** In `CHANGELOG.md:802/:967` — the gate-deletion history
...
`CHANGELOG.md:950`, which resolves and will pin happily — and points at installer prose, not the
