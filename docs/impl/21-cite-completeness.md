...
- **Slash and bare-colon continuations.** In `CHANGELOG.md:919/:1020` — the gate-deletion history
...
`CHANGELOG.md:1079`, which resolves and will pin happily — and points at installer prose, not the
