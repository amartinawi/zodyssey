...
- **Slash and bare-colon continuations.** In `CHANGELOG.md:899/:1000` — the gate-deletion history
...
`CHANGELOG.md:1059`, which resolves and will pin happily — and points at installer prose, not the
