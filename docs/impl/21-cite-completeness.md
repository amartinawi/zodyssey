...
- **Slash and bare-colon continuations.** In `CHANGELOG.md:835/:1000` — the gate-deletion history
...
`CHANGELOG.md:995`, which resolves and will pin happily — and points at installer prose, not the
