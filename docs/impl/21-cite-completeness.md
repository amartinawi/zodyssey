...
- **Slash and bare-colon continuations.** In `CHANGELOG.md:786/:951` — the gate-deletion history
...
`CHANGELOG.md:934`, which resolves and will pin happily — and points at installer prose, not the
