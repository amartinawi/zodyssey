...
- **Slash and bare-colon continuations.** In `CHANGELOG.md:936/:1037` — the gate-deletion history
...
`CHANGELOG.md:1096`, which resolves and will pin happily — and points at installer prose, not the
