...
- **Slash and bare-colon continuations.** In `CHANGELOG.md:601/:766` — the gate-deletion history
...
`CHANGELOG.md:749`, which resolves and will pin happily — and points at installer prose, not the
