...
- **Slash and bare-colon continuations.** In `CHANGELOG.md:635/:800` — the gate-deletion history
  row 04 cites — only the `:635` half was ever seen, and prose continuations ("the verdict gate
...
`CHANGELOG.md:783`, which resolves and will pin happily — and points at installer prose, not the
