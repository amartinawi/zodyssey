...
- **Slash and bare-colon continuations.** In `CHANGELOG.md:959/:1060` — the gate-deletion history
...
`CHANGELOG.md:1119`, which resolves and will pin happily — and points at installer prose, not the
