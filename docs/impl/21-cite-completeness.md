...
- **Slash and bare-colon continuations.** In `CHANGELOG.md:688/:853` — the gate-deletion history
...
`CHANGELOG.md:836`, which resolves and will pin happily — and points at installer prose, not the
