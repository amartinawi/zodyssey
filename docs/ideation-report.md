...
- **Evidence:** `CHANGELOG.md:27` (named terminus, deliberately unshipped — "it wants its own
...
(explicitly blocked on harness support, `CHANGELOG.md:56`); any additional reviewer/verifier agent
...
(`CHANGELOG.md:27`); the map demotes it ("flips the sign but stays in the same game," §2.1).
...
remained the unbounded residual (`:126`, `CHANGELOG.md:24`) — a sign-flip alone demonstrably did
